...
def seed_database():
    ...
    Location(country='Latvia', city='Jelgava', address='Raiņa iela 7', latitude=56.6514, longitude=23.7190, timeframe='09:00-10:00', route_id=test_route.id),
    Location(country='Latvia', city='Jelgava', address='Lielā iela 15', latitude=56.6491, longitude=23.7285, timeframe='10:00-11:00', route_id=test_route.id),
    ...
    Location(country='Latvia', city='Jēkabpils', address='Kurzemes iela 9', latitude=56.4981, longitude=25.8625, timeframe='10:00-11:00', route_id=test_route.id),
    Location(country='Latvia', city='Saldus', address='Rīgas iela 2', latitude=56.6636, longitude=22.4906, timeframe='12:00-13:00', route_id=test_route.id),
    ...
    Location(country='Latvia', city='Rēzekne', address='Latgales iela 15', latitude=56.5059, longitude=27.3344, timeframe='10:00-11:00', route_id=test_route.id),
    Location(country='Latvia', city='Kuldīga', address='Baznīcas iela 9', latitude=56.9672, longitude=21.9697, timeframe='11:00-12:00', route_id=test_route.id),
    ...
    db.session.add_all(locations_35)
    db.session.commit()
